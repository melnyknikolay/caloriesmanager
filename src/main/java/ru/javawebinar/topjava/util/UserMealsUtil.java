...
public class UserMealsUtil {
        static List<UserMeal> mealList = Arrays.asList(
    ...
    public static void main(String[] args) {
        ...
        List<UserMealWithExceed> filteredMealsWithExceeded = getFilteredWithExceeded(UserMealsUtil.mealList, LocalTime.of(7, 0), LocalTime.of(22, 0), 2000);
    ...
    public static List<UserMeal> inMemoryList(){
        return mealList;
    }
}